...
public:
    void topview(double leng, double breadth, double r,Document_Interface *doc);
    void frontview(double height, double leng, double breadth,double x, double CH,double r,Document_Interface *doc);
    void sideview(double x,double breadth, double leng,double height,double r, double CH,Document_Interface *doc);
...
private:
    QString errmsg;
        ...
        QLineEdit *cycradius;
        QLineEdit *toplayeredit;
        QLineEdit *frontlayeredit;
        QLineEdit *sidelayeredit;
